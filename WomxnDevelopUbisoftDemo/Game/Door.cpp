	...
	, m_bColor{ 1.0f }
{
	...
	m_Rectangle.setOutlineColor(sf::Color(0, 0, 0, 0));//{ /*static_cast<uint8_t>(m_rColor * 255.0f), static_cast<uint8_t>(m_gColor * 255.0f), static_cast<uint8_t>(m_bColor * 255.0f)*/ });
}
